  ...
  <main class="conteudo">
      <section class="conteudo-principal">
        ...
        <div class="conteudo-principal-escrito">
          ...
          <div class="container">
            <div>                  
              <a href="{{ route('theory', 'division') }}" class="button">Teoria</a>
              <a href="{{ route('exercicios', 'divisao') }}" class="button">Exercícios</a>
              <a href="{{ route('calculadora') }}" class="button">Calculadora</a>
              <a href="{{ route('performance', 'divisao') }}" class="button">Desempenho</a>
            </div>
            <img class="conteudo-principal-escrito-imagem" src="{{ asset('img/imgs/preguica.png') }}" alt="Imagem logo do site">
          </div>
        </div>
      </section>
  </main>
