  ...
  <main class="conteudo">
      <section class="conteudo-principal">
        ...
        <div class="conteudo-principal-escrito">
          ...
          <div class="container">
            <div>                  
              <a href="{{ route('theory', 'multiplication') }}" class="button">Teoria</a>
              <a href="{{ route('exercicios', 'multiplicacao') }}" class="button">Exercícios</a>
              <a href="{{ route('calculadora') }}" class="button">Calculadora</a>
              <a href="{{ route('performance', 'multiplicacao') }}" class="button">Desempenho</a>
            </div>
            <img class="conteudo-principal-escrito-imagem" src="{{ asset('img/imgs/a.png') }}" alt="Imagem de Multiplicação">
          </div>
        </div>
      </section>
  </main>
