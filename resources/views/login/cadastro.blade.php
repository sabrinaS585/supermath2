...
<section class="conteudo-principal">
    <div class="conteudo-centralizado">
        <h1 class="conteudo-principal-escrito-titulo">Cadastro</h1>
        ...
        <form action="{{ route('login.cadastro') }}" method="POST" class="formulario">
            @csrf
            ...
            <button type="submit" class="button">Cadastro</button>
