...
<body>
    ...
    <main class="conteudo">
        ...
        <a href="{{ route('salvarResolucao', 'subtracao') }}" class="buttonvoltar">&#8592;</a>
            <div class="conteudo-principal-escrito">
                ...
                <div class="quiz">
                    ...
                    <div class="options">
                        <form method="POST" action="{{ route('conferirResposta', 'subtracao') }}">
                            @csrf
                    ...
                    <a href="{{ route('desempenhoDireto', 'subtracao') }}" class="botao-desempenho">Ver Desempenho</a>
                </div>
            </div>
